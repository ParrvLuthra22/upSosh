                    ...
                    <div className="lg:w-2/3">
                        <div className="bg-surface p-8 md:p-10 rounded-3xl border border-white/10 space-y-4">
                            ...
                            <a
                                ...
                                className="inline-block w-full text-center py-4 rounded-xl font-bold text-lg bg-lime text-void hover:opacity-90 shadow-lg shadow-lime/20 transition-all"
                            >
