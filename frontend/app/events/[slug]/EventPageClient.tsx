  ...
  return (
    <div className="bg-surface border border-border rounded-xl p-3 flex items-center gap-3">
      ...
      <div className="min-w-0">
        ...
        <p className="font-sans text-[11px] text-cream-dim mt-0.5">
  ...
  return (
    <div className="mt-4 rounded-2xl overflow-hidden border border-border" style={{ aspectRatio: '2/1' }}>
      ...
      <a
        ...
        className="flex items-center gap-1.5 mt-2 font-mono text-[11px] text-cream-dim hover:text-lime transition-colors uppercase tracking-wider"
      >
...
function ShareBar({ title }: { title: string }) {
  ...
  return (
    <div className="flex items-center gap-2 mt-3">
      <span className="font-mono text-[11px] text-cream-dim uppercase tracking-wider mr-1">Share</span>
      <a
      ...
      <div className="flex items-center justify-around border-t border-border mt-5 pt-5">
        {[
          ...
          <div key={label} className="flex flex-col items-center gap-1.5">
            ...
            <span className="font-sans text-[11px] text-cream-dim">{label}</span>
          </div>
        ))}
      </div>
    </motion.div>
...
function ErrorScreen({ onRetry }: { onRetry: () => void }) {
  return (
    <div className="min-h-screen bg-void flex flex-col items-center justify-center px-6 text-center">
      <p className="font-mono text-[11px] uppercase tracking-[0.2em] text-cream-dim mb-4">[ CONNECTION ERROR ]</p>
