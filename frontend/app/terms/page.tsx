          ...
          >
            ...
            <div className="space-y-8 text-cream-dim">
              ...
              <section className="glass-card" id="definitions">
                <h2 className="text-3xl font-bold text-cream mb-6">1. Definitions</h2>
              ...
              <section className="glass-card" id="account">
                <h2 className="text-3xl font-bold text-cream mb-6">3. Account Creation & User Eligibility</h2>
                
                <div className="mb-6">
                  <h3 className="text-xl font-bold text-cream mb-4">To use upSosh:</h3>
                  <ul className="space-y-2">
              ...
              <section className="glass-card" id="host-registration">
                <h2 className="text-3xl font-bold text-cream mb-6">4. Host Registration & Obligations</h2>
                
                <div className="mb-6">
                  <h3 className="text-xl font-bold text-cream mb-4">All Hosts must:</h3>
                  <ul className="space-y-2">
              ...
              <section className="glass-card" id="user-responsibilities">
                <h2 className="text-3xl font-bold text-cream mb-6">5. User Responsibilities</h2>
                
                <div className="mb-6">
                  <h3 className="text-xl font-bold text-cream mb-4">Users must:</h3>
                  <ul className="space-y-2">
              ...
              <section className="glass-card" id="fmc">
                <h2 className="text-3xl font-bold text-cream mb-6">6. Fixed Minimal Cost (FMC) Framework</h2>
                ...
                <div className="space-y-6">
                  <div className="border-l-4 border-lime pl-6">
                    <h3 className="text-xl font-bold text-lime mb-4">6.1 Host Responsibilities for FMC</h3>
              ...
              <section className="glass-card" id="cancellations">
                <h2 className="text-3xl font-bold text-cream mb-6">8. Cancellations, Refunds & Rescheduling</h2>
              ...
              <section className="glass-card" id="prohibited">
                <h2 className="text-3xl font-bold text-cream mb-6">10. Prohibited Actions</h2>
              ...
              <section className="glass-card" id="privacy">
                ...
                <p className="text-sm italic">Full details are in the <a href="/privacy" className="text-lime hover:underline font-semibold">Privacy Policy</a>.</p>
              </section>

              
              <section className="glass-card" id="ip">
                <h2 className="text-3xl font-bold text-cream mb-6">12. Intellectual Property</h2>
              ...
              <section className="glass-card" id="suspension">
                <h2 className="text-3xl font-bold text-cream mb-6">13. Suspension & Termination</h2>
              ...
              <section className="glass-card" id="indemnity">
                <h2 className="text-3xl font-bold text-cream mb-6">14. Indemnity</h2>
              ...
              <section className="glass-card" id="contact">
                <h2 className="text-3xl font-bold text-cream mb-6">17. Contact Information</h2>
                
                <div className="bg-gradient-to-r from-lime to-lime/70 text-void p-6 rounded-xl">
