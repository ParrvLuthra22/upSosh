          ...
          >
            ...
            <div className="space-y-8 text-cream-dim">
              ...
              <section className="glass-card" id="data-types">
                <h2 className="text-3xl font-bold text-cream mb-6">2. Types of Personal Data We Collect</h2>
                ...
                <div className="grid md:grid-cols-2 gap-6 mb-6">
                  <div className="glass-card border-2 border-lime">
                    <h3 className="text-xl font-bold text-cream mb-4">2.1 Personal Data You Provide</h3>
                    <ul className="space-y-2">
              ...
              <section className="glass-card" id="purpose">
                <h2 className="text-3xl font-bold text-cream mb-6">3. Purpose of Data Collection</h2>
                <p className="mb-6">We use your information for:</p>
                
                <div className="space-y-6">
                  <div className="border-l-4 border-lime pl-6">
                    <h3 className="text-xl font-bold text-lime mb-3">3.1 Service Delivery (Contractual Necessity)</h3>
                    <ul className="space-y-2">
              ...
              <section className="glass-card" id="sharing">
                <h2 className="text-3xl font-bold text-cream mb-4">5. Data Sharing & Disclosure</h2>
                ...
                <div className="space-y-6">
                  <div className="glass-card border-2 border-lime">
                    <h3 className="text-xl font-bold text-cream mb-4">5.1 Third-Party Service Providers</h3>
                  ...
                  <div className="glass-card border-2 border-lime">
                    <h3 className="text-xl font-bold text-cream mb-4">5.2 Event Hosts</h3>
              ...
              <section className="glass-card" id="storage">
                ...
                <h3 className="text-xl font-bold text-cream mb-4">6.1 Data Retention</h3>
              ...
              <section className="glass-card" id="rights">
                <h2 className="text-3xl font-bold text-cream mb-4">9. User Rights (DPDP Act, 2023)</h2>
              ...
              <section className="glass-card" id="transfers">
                <h2 className="text-3xl font-bold text-cream mb-4">10. Cross-Border Data Transfers</h2>
              ...
              <section className="glass-card" id="cookies">
                <h2 className="text-3xl font-bold text-cream mb-4">11. Cookies (For Website Users)</h2>
              ...
              <section className="glass-card" id="third-party">
                <h2 className="text-3xl font-bold text-cream mb-4">12. Third-Party Links</h2>
              ...
              <section className="glass-card" id="updates">
                <h2 className="text-3xl font-bold text-cream mb-4">13. Updates to This Policy</h2>
              ...
              <section className="glass-card" id="grievance">
                ...
                <div className="bg-lime/10 border-2 border-lime/30 p-6 rounded-xl">
                  ...
                  <div className="space-y-2 mb-4">
                    ...
                    <p><strong>Email:</strong> <a href="mailto:grievance@upsosh.app" className="text-lime hover:underline">grievance@upsosh.app</a></p>
              ...
              <section className="glass-card" id="contact">
                <h2 className="text-3xl font-bold text-cream mb-6">15. How to Contact Us</h2>
                <div className="glass-card border-2 border-lime p-6">
                  <h3 className="text-xl font-bold mb-4">upSosh Technologies</h3>
                  <div className="space-y-2">
                    <p><strong>Email:</strong> <a href="mailto:privacy@upsosh.app" className="text-lime hover:underline">privacy@upsosh.app</a></p>
                    <p><strong>Support Phone:</strong> <a href="tel:+918076524225" className="text-lime hover:underline">+91 8076524225</a></p>
