    ...
    <div className="min-h-screen pt-24 pb-16 bg-black">
      <div className="max-w-5xl mx-auto px-4">
        ...
        <div className="text-center mb-16">
          <h1 className="text-5xl md:text-6xl font-bold mb-6 text-[#D4A017]" style={{ fontFamily: 'var(--font-jersey)' }}>
            About upSosh
          </h1>
          <p className="text-xl text-white/60 font-body" style={{ fontFamily: 'var(--font-lora)', lineHeight: '1.7' }}>
        ...
        <div className="mb-16">
          ...
          >
            <p className="text-lg leading-relaxed mb-6 text-white/70 font-body" style={{ fontFamily: 'var(--font-lora)', lineHeight: '1.7' }}>
            ...
            <p className="text-lg leading-relaxed text-white/70 font-body" style={{ fontFamily: 'var(--font-lora)', lineHeight: '1.7' }}>
        ...
        {/* How It Started */}
        <div className="mb-16">
          <h2 className="text-3xl md:text-4xl font-bold mb-8 text-white" style={{ fontFamily: 'var(--font-roboto-bbh)' }}>
            How It Started
          </h2>
          <div 
          ...
          >
            ...
            <p className="text-lg leading-relaxed font-bold text-white" style={{ fontFamily: 'var(--font-lora)', lineHeight: '1.7' }}>
        ...
        <div className="mb-16">
          ...
          >
            ...
            <ul className="space-y-3 mb-6 font-body" style={{ fontFamily: 'var(--font-lora)' }}>
        ...
        <div className="mb-16">
          ...
          >
            <p className="text-lg leading-relaxed mb-6 text-white font-bold font-body" style={{ fontFamily: 'var(--font-lora)', lineHeight: '1.7' }}>
            ...
            <p className="text-lg leading-relaxed mb-4 text-white/70 font-body" style={{ fontFamily: 'var(--font-lora)', lineHeight: '1.7' }}>
              We aim to:
            </p>
            <ul className="space-y-3 mb-6 font-body" style={{ fontFamily: 'var(--font-lora)' }}>
              <li className="flex items-start">
            ...
            <p className="text-xl leading-relaxed mt-6 text-white font-bold font-body" style={{ fontFamily: 'var(--font-lora)', lineHeight: '1.7' }}>
        ...
        {/* Founders Section */}
        <div className="mb-16">
          <h2 className="text-3xl md:text-4xl font-bold mb-8 text-center text-white" style={{ fontFamily: 'var(--font-roboto-bbh)' }}>
            Meet the Founders
          </h2>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="p-8 rounded-2xl text-center bg-black border border-white/10 hover:border-[#D4A017]/30 transition-colors">
              ...
              <h3 className="text-2xl font-bold mb-2 text-white" style={{ fontFamily: 'var(--font-roboto-bbh)' }}>
                Aadit Vachher
              </h3>
              <p className="text-lg mb-4 text-[#D4A017] font-semibold" style={{ fontFamily: 'var(--font-jersey)' }}>
                Co-Founder
              </p>
              <p className="text-base leading-relaxed text-white/60 font-body" style={{ fontFamily: 'var(--font-lora)', lineHeight: '1.7' }}>
