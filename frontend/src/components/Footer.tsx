...
const Footer = () => {
    ...
    return (
        <footer className="bg-neutral-50 dark:bg-neutral-900 border-t border-border pt-16 pb-8 mt-20 font-sans">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="flex gap-4 pt-2">
                            ...
                            <a
                                ...
                                className="w-10 h-10 rounded-full bg-neutral-100 dark:bg-neutral-800 flex items-center justify-center text-foreground/60 hover:text-foreground hover:bg-neutral-200 dark:hover:bg-neutral-700 transition-all duration-300 transform hover:scale-105"
