...
**Status: Part 1 done** — P2-1 through P2-5, P2-7, P2-8 (partial), P2-9. This closed the `src/` vs root split entirely (`frontend/src/` no longer exists) and the two-API-client bug. **Part 2 not started**: the design-system unification (P2-11→18) and the remaining shared-logic consolidation (P2-20→28) are open. P2-19 (EventCard / booking-store duplicate pairs) is *explicitly deferred*, not just unstarted — see its note.
